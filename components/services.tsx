    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 fade-in">
          <h2
            id="servicos-title"
            className="text-4xl lg:text-5xl font-serif font-bold title-shadow-right mb-4 text-[#3e5c4e]"
          >
            SERVIÇOS
          </h2>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center mb-6">
                  <IconComponent
                    className="w-8 h-8 mr-3 text-texto-servico"
                    aria-hidden="true"
                  />
                  <h3
                    id={`service-title-${index}`}
                    className="text-xl font-serif font-bold text-texto-servico"
                  >
                    {service.title}
                  </h3>
                </div>

                <p className="text-texto-servico font-medium mb-4 font-sans">
                  {service.subtitle}
                </p>
